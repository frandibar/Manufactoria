...
(define manufactoria-test-suite 
  (test-suite 
   ...
   (test-case
    "Robotoast! l1 - Accept everything"
   ...
   (test-case
    "Robocoffee! l2 - Accept if starts with blue"
   ...
   (test-case
    "Robolamp! l3 - Accept if three or more blues"
   ...
   (test-case
    "Robobugs! l5 - Accept alternating colors"
   ...
   (test-case
    "Robocats! l6 - Accept if ends with 2 blues"
   ...
   (test-case
    "Robobears! l7 - Accept if starts and ends with same color"
   ...
   (test-case
    "RC Cars! l8 - The input with the first symbol at the end"
   ...
   (test-case
    "Robocars! l9 - Replace blue with green and red with yellow"
   ...
   (test-case
    "Robostilts! l10 - Put a green at the beginning and a yellow at the end"
   ...
   ;; (test-case
   ;;  "Milidogs! l11 - With blue as 1 and red as 0 accept odd binary strings"
   ...
   (test-case
    "Roborockets! l25 - Swap blue for red and red for blue"
